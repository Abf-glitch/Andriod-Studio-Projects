package com.example.empty.ui.theme.screen.client
...
import com.example.empty.data.ClientViewmodel
...
@Composable
fun UpdatedClientScreen(navController: NavController){
    ...
    Scaffold (
        ...
        Column (Modifier.padding(innerPadding)) {
            ...
            OutlinedTextField(value = gender,
                ...
                placeholder = { Text(text = "What is Your Gender?") },
                label = { Text(text = "What is Your Gender?") },
                modifier = Modifier
                    .wrapContentWidth()
                    .align(Alignment.CenterHorizontally))
...
fun UpdateClientScreenPreview() {
    UpdatedClientScreen(rememberNavController())
}